...
namespace up_console
    ...
    public class MyInformation
        ...
        /// </summary>
        private static string[] Scopes { get; set; } = new string[] { "User.Read", "User.Read.All", "User.ReadBasic.All" };
        ...
        private string WebApiUrlMyGroups { get { return $"{MicrosoftGraphBaseEndpoint}/v1.0/me/transitiveMemberOf/microsoft.graph.group"; } }
        ...
        private async Task DisplayMeAndMyManagerAsync()
            ...
            if (authenticationResult != null)
                ...
                await CallWebApiAndDisplayResultAsync(WebApiUrlMyGroups, accessToken, "My Groups");
                }
            }
